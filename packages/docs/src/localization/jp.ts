...
const lang: Lang = {
  index: {
    ...
    description: [
      ...
      { tag: 'span', class: sx('font-mono'), children: 'cssx' },
    ...
    worksWith: [{ tag: 'span', class: sx('font-mono'), children: 'cssx' }, ' は以下の環境に対応しています'],
  },
  docs: {
    title: 'ドキュメント',
    description: [
      ...
      {
        tag: 'a',
        class: sx('text-brand underline underline-offset-2'),
